...
def run(voc_root, year, split, output_dir, shuffling=True):
    # 如果output_dir不存在则创建
...
if __name__ == '__main__':
    ...
    vocpath = "/home/work/learn/myMobileNetv2-SSDLite/MobileNetv2-SSDLite/ssdlite"
    run(vocpath, 2028, 'trainval', './voc2008recoder/')
